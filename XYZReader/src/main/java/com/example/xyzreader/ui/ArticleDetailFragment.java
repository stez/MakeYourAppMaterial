...
public class ArticleDetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        nestedScrollView = (NestedScrollView) mRootView.findViewById(R.id.scroll);
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY).substring(0, 5000).replaceAll("(\r\n|\n)", "<br />")));
            shareFab.show();
            ...
            nestedScrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() {
                ...
                public void onScrollChange(View view, int i, int i1, int i2, int i3) {
                    if (i1 - i3 < 0 && !shareFab.isShown())
                        shareFab.show();
                    else if (i1 - i3 >= 0 && shareFab.isShown())
                        shareFab.hide();
                }
            });
